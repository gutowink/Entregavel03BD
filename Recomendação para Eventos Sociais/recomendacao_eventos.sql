...
INSERT INTO evento (id, nome, data, usuarioid, administradorid, categoriaid) VALUES
        ('EV001', 'Workshop de Python', '2024-03-10', '111.111.111-11', '999.999.999-99', 'CAT001'),
        ('EV002', 'Feira de Inovação', '2024-04-15', '222.222.222-22', '888.888.888-88', 'CAT008'),
        ('EV003', 'Palestra sobre AI', '2024-05-05', '333.333.333-33', '777.777.777-77', 'CAT002'),
        ('EV004', 'Congresso de TI', '2024-06-20', '444.444.444-44', '666.666.666-66', 'CAT013'),
        ('EV005', 'Hackathon', '2024-07-30', '555.555.555-55', '555.555.555-55', 'CAT006'),
        ('EV006', 'Seminário de Cloud', '2024-08-25', '666.666.666-66', '444.444.444-44', 'CAT007'),
        ('EV007', 'Treinamento de Segurança', '2024-09-10', '777.777.777-77', '333.333.333-33', 'CAT003'),
        ('EV008', 'Curso de DevOps', '2024-10-05', '888.888.888-88', '222.222.222-22', 'CAT005'),
        ('EV009', 'Encontro de Startups', '2024-11-15', '999.999.999-99', '111.111.111-11', 'CAT009'),
        ('EV010', 'Workshop de UX/UI', '2024-12-01', '123.123.123-12', '101.101.101-10', 'CAT011');
...
CREATE TABLE mensagem
(
    id VARCHAR(15) PRIMARY KEY AUTOINCREMENT,
...
INSERT INTO mensagem (mensagem, data_envio, usuarioid) VALUES
        ('Olá, como você está?', '2024-01-15', '111.111.111-11'),
        ('Estou interessado no evento.', '2024-01-16', '222.222.222-22'),
        ('Aguardo mais informações.', '2024-01-17', '333.333.333-33'),
        ('Podemos nos encontrar amanhã?', '2024-01-18', '444.444.444-44'),
        ('Gostaria de confirmar minha presença.', '2024-01-19', '555.555.555-55'),
        ('Qual será o local do evento?', '2024-01-20', '666.666.666-66'),
        ('Estou animado para o workshop!', '2024-01-21', '777.777.777-77'),
        ('Pode me enviar o link de inscrição?', '2024-01-22', '888.888.888-88'),
        ('Agradeço pela informação!', '2024-01-23', '999.999.999-99'),
        ('Estou pronto para participar!', '2024-01-24', '123.123.123-12'),
        ('Por favor, me mantenha atualizado.', '2024-01-25', '321.321.321-32'),
        ('Quero discutir algumas ideias.', '2024-01-26', '456.456.456-45'),
        ('Muito obrigado pela ajuda.', '2024-01-27', '654.654.654-65'),
        ('Vamos nos reunir para mais detalhes?', '2024-01-28', '789.789.789-78'),
        ('Espero vê-lo no evento!', '2024-01-29', '987.987.987-98');