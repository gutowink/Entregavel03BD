...
INSERT INTO gestor (codigo, nome_completo, departamento) VALUES
        ('G001', 'Ana Silva', 'Recursos Humanos'),
        ('G002', 'Bruno Almeida', 'Financeiro'),
        ('G003', 'Carla Souza', 'Marketing'),
        ('G004', 'Daniel Ferreira', 'TI'),
        ('G005', 'Eduardo Lima', 'Vendas'),
        ('G006', 'Fernanda Costa', 'Logística'),
        ('G007', 'Gabriel Oliveira', 'Produção'),
        ('G008', 'Helena Pereira', 'Pesquisa e Desenvolvimento'),
        ('G009', 'Isabela Martins', 'Compras'),
        ('G010', 'João Santos', 'Jurídico'),
        ('G011', 'Laura Mendes', 'Recursos Humanos'),
        ('G012', 'Marcelo Costa', 'Financeiro'),
        ('G013', 'Nina Figueiredo', 'Marketing'),
        ('G014', 'Otávio Monteiro', 'TI'),
        ('G015', 'Paula Ribeiro', 'Vendas');

INSERT INTO venda (produto, data_venda, quantidade, funcionarioid) VALUES
        ('Notebook', '2024-01-10', 5, 'F001'),
        ('Smartphone', '2024-01-12', 10, 'F002'),
        ('Tablet', '2024-01-15', 7, 'F003'),
        ('Televisão', '2024-01-18', 3, 'F004'),
        ('Impressora', '2024-01-20', 4, 'F005'),
        ('Mouse', '2024-01-25', 15, 'F006'),
        ('Monitor', '2024-01-28', 6, 'F007'),
        ('Teclado', '2024-02-01', 8, 'F008'),
        ('Câmera', '2024-02-03', 2, 'F009'),
        ('Fone de Ouvido', '2024-02-05', 12, 'F010'),
        ('Roteador', '2024-02-07', 9, 'F011'),
        ('HD Externo', '2024-02-09', 11, 'F012'),
        ('Pen Drive', '2024-02-12', 20, 'F013'),
        ('Carregador', '2024-02-14', 14, 'F014'),
        ('Cabo HDMI', '2024-02-16', 18, 'F015');
...
-- Inserção de dados na tabela meta: 4 metas por funcionário, uma para cada categoria
...
FROM
    avaliacao a
        JOIN
    funcionario f ON a.funcionarioid = f.codigo
        LEFT JOIN
    funcionario g ON a.gestorid = g.codigo
ORDER BY
    f.nome_completo;
